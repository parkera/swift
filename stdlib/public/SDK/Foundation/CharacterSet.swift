...
@_silgen_name("__Swift_CFURLComponentsCopyURLUserAllowedCharacterSet")
internal func __Swift_CFURLComponentsCopyURLUserAllowedCharacterSet() -> CFCharacterSet

@_silgen_name("__Swift_CFURLComponentsGetURLPasswordAllowedCharacterSet")
internal func __Swift_CFURLComponentsGetURLPasswordAllowedCharacterSet() -> CFCharacterSet

@_silgen_name("__Swift_CFURLComponentsGetURLHostAllowedCharacterSet")
internal func __Swift_CFURLComponentsGetURLHostAllowedCharacterSet() -> CFCharacterSet

@_silgen_name("__Swift_CFURLComponentsGetURLPathAllowedCharacterSet")
internal func __Swift_CFURLComponentsGetURLPathAllowedCharacterSet() -> CFCharacterSet

@_silgen_name("__Swift_CFURLComponentsGetURLQueryAllowedCharacterSet")
internal func __Swift_CFURLComponentsGetURLQueryAllowedCharacterSet() -> CFCharacterSet

@_silgen_name("__Swift_CFURLComponentsGetURLFragmentAllowedCharacterSet")
internal func __Swift_CFURLComponentsGetURLFragmentAllowedCharacterSet() -> CFCharacterSet
...
public struct CharacterSet : ReferenceConvertible, Equatable, Hashable, SetAlgebra {
    ...
    public static var urlUserAllowed : CharacterSet {
        return CharacterSet(_uncopiedImmutableReference: __Swift_CFURLComponentsCopyURLUserAllowedCharacterSet())
    }
    
    /// Returns the character set for characters allowed in a password URL subcomponent.
    public static var urlPasswordAllowed : CharacterSet {
        return CharacterSet(_uncopiedImmutableReference: __Swift_CFURLComponentsGetURLPasswordAllowedCharacterSet())
    }
    
    /// Returns the character set for characters allowed in a host URL subcomponent.
    public static var urlHostAllowed : CharacterSet {
        return CharacterSet(_uncopiedImmutableReference: __Swift_CFURLComponentsGetURLHostAllowedCharacterSet())
    }
    
    /// Returns the character set for characters allowed in a path URL component.
    public static var urlPathAllowed : CharacterSet {
        return CharacterSet(_uncopiedImmutableReference: __Swift_CFURLComponentsGetURLPathAllowedCharacterSet())
    }
    
    /// Returns the character set for characters allowed in a query URL component.
    public static var urlQueryAllowed : CharacterSet {
        return CharacterSet(_uncopiedImmutableReference: __Swift_CFURLComponentsGetURLQueryAllowedCharacterSet())
    }
    
    /// Returns the character set for characters allowed in a fragment URL component.
    public static var urlFragmentAllowed : CharacterSet {
        return CharacterSet(_uncopiedImmutableReference: __Swift_CFURLComponentsGetURLFragmentAllowedCharacterSet())
    }
